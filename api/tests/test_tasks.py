...
class TaskAPITests(APITestSetup):
    def test_task_creation(self):
        ...
        task_data = {"title": "Test Task", "user": "newuser", "due_date": "2024-12-31T00:00:00Z"}
    ...
    def test_task_detail(self):
        self.authenticate_user()
        task = self.client.post(reverse("task-create"), {"title": "Test Task", "user": "newuser", "due_date": "2024-12-31T00:00:00Z"}).data
    ...
    def test_task_creation_with_invalid_data(self):
        self.authenticate_user()
        url = reverse("task-create")
        invalid_task_data = {"title": "", "user": "newuser", "due_date": "invalid-date"}
